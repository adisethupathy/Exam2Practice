...
def run_test_practice_problem2a():
    ...
    list = [2, 3, 4]
    new_list = practice_problem2a(list, 6)
    print('Expected: ')
    print([8, 9, 10])
    print('Actual:  ')
    print(new_list)
    ...
    list = [67, 30]
    new_list = practice_problem2a(list, 2)
    print('Expected: ')
    print([69, 32])
    print('Actual:  ')
    print(new_list)
    ...
    list = [12, 13, 213]
    new_list = practice_problem2a(list, -4)
    print('Expected: ')
    print([8, 9, 209])
    print('Actual:  ')
    print(new_list)
    ...
    new_list = practice_problem2a(list, -10)
    print('Expected: ')
    print([0, 90, 990, 9990])
    print('Actual:  ')
    print(new_list)
